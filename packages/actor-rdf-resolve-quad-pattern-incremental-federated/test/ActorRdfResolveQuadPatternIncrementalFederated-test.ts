...
describe('ActorRdfResolveQuadPatternIncrementalFederated', () => {
  let bus: any;
  ...
  describe('The ActorRdfResolveQuadPatternIncrementalFederated module', () => {
    it('should be a function', () => {
      expect(ActorRdfResolveQuadPatternIncrementalFederated).toBeInstanceOf(Function);
    });

    it('should be a ActorRdfResolveQuadPatternIncrementalFederated constructor', () => {
      expect(new (<any> ActorRdfResolveQuadPatternIncrementalFederated)(
        { name: 'actor', bus, mediatorResolveQuadPattern, skipEmptyPatterns },
      ))
        .toBeInstanceOf(ActorRdfResolveQuadPatternIncrementalFederated);
      expect(new (<any> ActorRdfResolveQuadPatternIncrementalFederated)(
        { name: 'actor', bus, mediatorResolveQuadPattern, skipEmptyPatterns },
      ))
    ...
    it('should not be able to create new ActorRdfResolveQuadPatternIncrementalFederated objects without \'new\'', () => {
      expect(() => { (<any> ActorRdfResolveQuadPatternIncrementalFederated)(); }).toThrow();
    });
  });
  ...
  describe('An ActorRdfResolveQuadPatternIncrementalFederated instance', () => {
    ...
    beforeEach(() => {
      actor = new ActorRdfResolveQuadPatternIncrementalFederated(
        { name: 'actor', bus, mediatorResolveQuadPattern, skipEmptyPatterns },
      );
    });
