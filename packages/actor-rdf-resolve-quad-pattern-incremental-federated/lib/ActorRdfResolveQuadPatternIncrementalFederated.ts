...
import { IncrementalFederatedQuadSource } from './IncrementalFederatedQuadSource';

/**
 * A comunica Federated RDF Resolve Quad Pattern Actor.
 */
export class ActorRdfResolveQuadPatternIncrementalFederated extends ActorRdfResolveQuadPatternSource
  ...
  protected async getSource(context: IActionContext): Promise<IQuadSource> {
    return new IncrementalFederatedQuadSource(
