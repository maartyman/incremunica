...
import { ActorRdfJoinMinusIncrementalHash } from '../lib/ActorRdfJoinMinusIncrementalHash';
...
describe('ActorRdfJoinMinusIncrementalHash', () => {
  let bus: any;
  ...
  describe('The ActorRdfJoinMinusIncrementalHash module', () => {
    it('should be a function', () => {
      expect(ActorRdfJoinMinusIncrementalHash).toBeInstanceOf(Function);
    });

    it('should be a ActorRdfJoinMinusIncrementalHash constructor', () => {
      expect(new (<any> ActorRdfJoinMinusIncrementalHash)({ name: 'actor', bus })).toBeInstanceOf(ActorRdfJoinMinusIncrementalHash);
      expect(new (<any> ActorRdfJoinMinusIncrementalHash)({ name: 'actor', bus })).toBeInstanceOf(ActorRdfJoin);
    });

    it('should not be able to create new ActorRdfJoinMinusIncrementalHash objects without \'new\'', () => {
      expect(() => { (<any> ActorRdfJoinMinusIncrementalHash)(); }).toThrow();
    });
  });

  describe('An ActorRdfJoinMinusIncrementalHash instance', () => {
    let mediatorJoinSelectivity: MediatorRdfJoinSelectivity;
    let actor: ActorRdfJoinMinusIncrementalHash;

    beforeEach(() => {
      mediatorJoinSelectivity = <any> {
        mediate: async() => ({ selectivity: 1 }),
      };
      actor = new ActorRdfJoinMinusIncrementalHash({ name: 'actor', bus, mediatorJoinSelectivity });
    });
