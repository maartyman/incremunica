...
import { ActorRdfJoinOptionalIncrementalUnion } from '../lib/ActorRdfJoinOptionalIncrementalUnion';
...
describe('ActorRdfJoinOptionalIncrementalUnionBind', () => {
  let bus: any;
  ...
  describe('An ActorRdfJoinOptionalIncrementalUnion instance', () => {
    ...
    let actor: ActorRdfJoinOptionalIncrementalUnion;
    ...
    beforeEach(() => {
      ...
      actor = new ActorRdfJoinOptionalIncrementalUnion({
        name: 'actor',
        bus,
