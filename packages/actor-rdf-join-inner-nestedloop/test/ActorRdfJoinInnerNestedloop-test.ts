...
describe('ActorRdfJoinNestedLoop', () => {
  ...
  describe('The ActorRdfJoinNestedLoop module', () => {
    it('should be a function', () => {
      expect(ActorRdfJoinInnerNestedloop).toBeInstanceOf(Function);
    });

    it('should be a ActorRdfJoinNestedLoop constructor', () => {
      expect(new (<any> ActorRdfJoinInnerNestedloop)({ name: 'actor', bus }))
        .toBeInstanceOf(ActorRdfJoinInnerNestedloop);
      expect(new (<any> ActorRdfJoinInnerNestedloop)({ name: 'actor', bus }))
    ...
    it('should not be able to create new ActorRdfJoinNestedLoop objects without \'new\'', () => {
      expect(() => {
        (<any> ActorRdfJoinInnerNestedloop)();
      }).toThrow('Class constructor ActorRdfJoinInnerNestedloop cannot be invoked without \'new\'');
    });
  });
...
>;
    let actor: ActorRdfJoinInnerNestedloop;
    ...
    beforeEach(() => {
      ...
      actor = new ActorRdfJoinInnerNestedloop({ name: 'actor', bus, mediatorJoinSelectivity });
      variables0 = [];
      variables1 = [];
      action = {
        type: 'inner',
    ...
    describe('should test', () => {
      ...
      it('should handle undefs in left stream', async() => {
        ...
        expect((await actor.test(action)).get()).toEqual({
          iterations: 0,
          persistedItems: 0,
          blockingItems: 0,
          requestTime: 0,
