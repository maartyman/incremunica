...
import { NestedLoopJoin } from './NestedLoopJoin';

/**
 * A comunica Inner Nestedloop RDF Join Actor.
 */
export class ActorRdfJoinInnerNestedloop extends ActorRdfJoin {
  ...
  protected async getOutput(action: IActionRdfJoin): Promise<IActorRdfJoinOutputInner> {
    const bindingsStream = <BindingsStream><unknown> new NestedLoopJoin(
