...
import { DeleteHashJoin } from './DeleteHashJoin';

/**
 * A comunica Inner Delete Hash RDF Join Actor.
 */
export class ActorRdfJoinInnerDeleteHash extends ActorRdfJoin {
  public readonly mediatorHashBindings: MediatorHashBindings;

  public constructor(args: IActorRdfJoinInnerDeleteHashArgs) {
    super(args, {
      logicalType: 'inner',
  ...
  protected async getOutput(action: IActionRdfJoin): Promise<IActorRdfJoinOutputInner> {
    ...
    const bindingsStream = <BindingsStream><unknown> new DeleteHashJoin(
...
export interface IActorRdfJoinInnerDeleteHashArgs extends IActorRdfJoinArgs {
