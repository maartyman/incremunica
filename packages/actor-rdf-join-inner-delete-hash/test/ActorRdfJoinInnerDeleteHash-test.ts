...
import { ActorRdfJoinInnerDeleteHash } from '../lib/ActorRdfJoinInnerDeleteHash';
...
describe('ActorRdfJoinDeleteHash', () => {
  ...
  describe('The ActorRdfJoinDeleteHash module', () => {
    it('should be a function', () => {
      expect(ActorRdfJoinInnerDeleteHash).toBeInstanceOf(Function);
    });

    it('should be a ActorRdfJoinDeleteHash constructor', () => {
      expect(new (<any> ActorRdfJoinInnerDeleteHash)({ name: 'actor', bus }))
        .toBeInstanceOf(ActorRdfJoinInnerDeleteHash);
      expect(new (<any> ActorRdfJoinInnerDeleteHash)({ name: 'actor', bus }))
    ...
    it('should not be able to create new ActorRdfJoinDeleteHash objects without \'new\'', () => {
      expect(() => {
        (<any> ActorRdfJoinInnerDeleteHash)();
      }).toThrow('Class constructor ActorRdfJoinInnerDeleteHash cannot be invoked without \'new\'');
    });
  });
...
>;
    ...
    let actor: ActorRdfJoinInnerDeleteHash;
    ...
    beforeEach(() => {
      ...
      actor = new ActorRdfJoinInnerDeleteHash({
        name: 'actor',
        bus,
