...
describe('ActorRdfJoinFullHash', () => {
  ...
  describe('The ActorRdfJoinFullHash module', () => {
    ...
    it('should be a ActorRdfJoinFullHash constructor', () => {
      expect(new (<any> ActorRdfJoinInnerIncrementalFullHash)({ name: 'actor', bus })).toBeInstanceOf(ActorRdfJoinInnerIncrementalFullHash);
      expect(new (<any> ActorRdfJoinInnerIncrementalFullHash)({ name: 'actor', bus })).toBeInstanceOf(ActorRdfJoin);
    });

    it('should not be able to create new ActorRdfJoinFullHash objects without \'new\'', () => {
      expect(() => { (<any> ActorRdfJoinInnerIncrementalFullHash)(); }).toThrow();
    });
  });
