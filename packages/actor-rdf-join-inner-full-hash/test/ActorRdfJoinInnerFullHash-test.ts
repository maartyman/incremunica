...
import { ActorRdfJoinInnerFullHash } from '../lib';
...
describe('ActorRdfJoinFullHash', () => {
  ...
  describe('The ActorRdfJoinFullHash module', () => {
    it('should be a function', () => {
      expect(ActorRdfJoinInnerFullHash).toBeInstanceOf(Function);
    });

    it('should be a ActorRdfJoinFullHash constructor', () => {
      expect(new (<any> ActorRdfJoinInnerFullHash)({ name: 'actor', bus }))
        .toBeInstanceOf(ActorRdfJoinInnerFullHash);
      expect(new (<any> ActorRdfJoinInnerFullHash)({ name: 'actor', bus }))
    ...
    it('should not be able to create new ActorRdfJoinFullHash objects without \'new\'', () => {
      expect(() => {
        (<any> ActorRdfJoinInnerFullHash)();
      }).toThrow('Class constructor ActorRdfJoinInnerFullHash cannot be invoked without \'new\'');
    });
  });
...
>;
    let actor: ActorRdfJoinInnerFullHash;
