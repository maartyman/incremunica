...
import { ActorRdfJoinOptionalDifferentialBind } from '../lib/ActorRdfJoinOptionalDifferentialBind';
...
describe('ActorRdfJoinOptionalDifferentialBind', () => {
  let bus: any;
  ...
  describe('An ActorRdfJoinOptionalDifferentialBind instance', () => {
    ...
    let actor: ActorRdfJoinOptionalDifferentialBind;
    ...
    beforeEach(() => {
      ...
      actor = new ActorRdfJoinOptionalDifferentialBind({
        name: 'actor',
        bus,
