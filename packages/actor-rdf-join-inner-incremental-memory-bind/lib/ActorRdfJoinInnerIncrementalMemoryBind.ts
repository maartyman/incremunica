 ...
 */
export class ActorRdfJoinInnerIncrementalMemoryBind extends ActorRdfJoin {
  ...
  public async getOutput(
    ...
    const bindingsStream = <BindingsStream><unknown> await ActorRdfJoinInnerIncrementalMemoryBind.createBindStream(
