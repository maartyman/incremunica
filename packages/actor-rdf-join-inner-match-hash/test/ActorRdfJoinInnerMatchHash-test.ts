...
describe('ActorRdfJoinMatchHash', () => {
  ...
  describe('The ActorRdfJoinMatchHash module', () => {
    it('should be a function', () => {
      expect(ActorRdfJoinInnerMatchHash).toBeInstanceOf(Function);
    });

    it('should be a ActorRdfJoinMatchHash constructor', () => {
      expect(new (<any> ActorRdfJoinInnerMatchHash)({ name: 'actor', bus }))
        .toBeInstanceOf(ActorRdfJoinInnerMatchHash);
      expect(new (<any> ActorRdfJoinInnerMatchHash)({ name: 'actor', bus }))
    ...
    it('should not be able to create new ActorRdfJoinMatchHash objects without \'new\'', () => {
      expect(() => {
        (<any> ActorRdfJoinInnerMatchHash)();
      }).toThrow('Class constructor ActorRdfJoinInnerMatchHash cannot be invoked without \'new\'');
    });
  });
...
>;
    ...
    let actor: ActorRdfJoinInnerMatchHash;
    ...
    beforeEach(() => {
      ...
      actor = new ActorRdfJoinInnerMatchHash({
        name: 'actor',
        bus,
