...
import { ActorRdfJoinOptionalDifferential } from '../lib/ActorRdfJoinOptionalDifferential';
...
describe('ActorRdfJoinOptionalDifferentialBind', () => {
  ...
  describe('An ActorRdfJoinOptionalDifferential instance', () => {
    ...
    let actor: ActorRdfJoinOptionalDifferential;
    ...
    beforeEach(() => {
      ...
      actor = new ActorRdfJoinOptionalDifferential({
        name: 'actor',
        bus,
